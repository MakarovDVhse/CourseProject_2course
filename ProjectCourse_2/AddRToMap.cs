...
{
    public partial class AddRToMap : Form
    {
        Point CurrentPoint;
        Point PreviousPoint;
        Graphics graphics;
        ...
        public void AddPosition()
        {
            ...
            Program.MapPositionR.Add(Convert.ToInt32(Program.CurrentOpertedDataBase.Tables[1].Rows[Convert.ToInt32(Program.CurrentOpertedDataBase.Tables[1].Rows.Count - 1)][0]), map);
        }
        public AddRToMap()
        {
            InitializeComponent();
        ...
        private void AddRToMap_Load(object sender, EventArgs e)
        {
        ...
        {
            Program.CurrentOpertedDataBase.Tables[1].Rows.Add(new object[] { null, Program.road.Name, Program.road.Type, Program.road.ExtraInfo });
            AddPosition();
