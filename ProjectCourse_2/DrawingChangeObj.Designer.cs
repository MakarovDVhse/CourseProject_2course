...
{
    partial class DrawingChangeObj
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "DrawingChangeObj";
            this.Text = "Изменить элемент";
            this.Load += new System.EventHandler(this.DrawingChangeObj_Load);
