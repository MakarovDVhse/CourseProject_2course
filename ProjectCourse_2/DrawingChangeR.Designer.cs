...
namespace ProjectCourse_2
{
    partial class DrawingChangeR
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "DrawingChangeR";
            this.Text = "Изменить элемент";
            this.Load += new System.EventHandler(this.DrawingChangeR_Load);
